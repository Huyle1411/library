...
g++ -std=c++17 $1.cpp -o generator || { echo ${bold}${orange}Compilation Error in ${reset} $1.cpp; exit 1; }
echo "Compiling original solution ..."
g++ -std=c++17 $2.cpp -o original || { echo ${bold}${orange}Compilation Error${reset} in $2.cpp; exit 1; }
echo "Compiling brute force solution ..."
g++ -std=c++17 $3.cpp -o brute || { echo ${bold}${orange}Compilation Error${reset} in $3.cpp; exit 1; }
